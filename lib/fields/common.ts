...
//     const PropsArg: PropsArgObj = props.value;

//     // TODO:这里不知道问什么无法自动推断类型
//     const uiSchema = propsArgObj.uiSchema;
//     const schema = propsArgObj.schema;
//     const vjsf = propsArgObj.vjsf;
...
//     // TODO:这里不知道问什么无法自动推断类型
//     const uiSchemaTemp = uiSchema as UISchema;

//     const widget =
//       uiSchemaTemp.widget || getDefaultWidgetOfSchema(props.schema, type);
